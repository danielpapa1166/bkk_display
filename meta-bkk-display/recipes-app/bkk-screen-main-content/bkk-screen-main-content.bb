...
SRC_URI = "file://CMakeLists.txt                \
           ...
           file://content_state_machine.cpp     \
           file://content_state_machine.hpp     \
           "

S = "${WORKDIR}"

DEPENDS = "bkk-screen-owner bkk-api rbuflogd bkk-tee bkk-common-utils network-manager config-server"
